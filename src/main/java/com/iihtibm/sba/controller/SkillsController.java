...
import com.iihtibm.sba.service.SkillService;
...
public class SkillsController {
	...
	@ApiOperation(value = "Add skill details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
	...
	public com.iihtibm.sba.model.ApiResponse<?> addSkill(
			@ApiParam(value = "Skill object which needs to add", required = true) @Valid @RequestBody Skill skill) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.skill.add"), skillService.addSkill(skill));
		
	}

	@ApiOperation(value = "Update skill details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> updateSkill(
			@ApiParam(value = "Skill object which needs to update", required = true) @Valid @RequestBody Skill skill) {

		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.skill.update"), skillService.updateSkill(skill));
		
	}

	@ApiOperation(value = "Delete skill details", response = com.iihtibm.sba.model.ApiResponse.class)
	@ApiResponses(value = {
		@ApiResponse(code = 200, message = "Successfully performed the operation"),
		@ApiResponse(code = 404, message = "Resource Not Found"),
		@ApiResponse(code = 503, message = "Service Unavailable")
	...
	public com.iihtibm.sba.model.ApiResponse<?> deleteSkill(
			@ApiParam(value = "Skill Id for which record needs to delete", required = true) @PathVariable(value = "id", required = true) Long id) {

		skillService.deleteSkill(id);
		return new com.iihtibm.sba.model.ApiResponse<>(HttpStatus.OK.value(), Translator.toLocale("success.skill.delete"));
	}
}